...
public class CarSpawner : MonoBehaviour
{
    ...
    {	
    	...
    	if(Timer<0 && Go == true){
            GameObject CarPrefab_o = Instantiate(CarPrefab, Spawn1.position, CarPrefab.transform.rotation) as GameObject;
	        

	    	GameObject CarPrefab_o2 = Instantiate(CarPrefab2, Spawn2.position, CarPrefab2.transform.rotation) as GameObject;
